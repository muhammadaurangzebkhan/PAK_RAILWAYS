document.addEventListener('DOMContentLoaded', () => {
    ...
    const renderSchedules = () => {
        ...
        const departuresData = allSchedules.lhr_fsld_departure || [];
        const arrivalsData = allSchedules.fsld_lhr_arrival || [];

        populateTable(departuresTableBody, departuresData, 'lhr_fsld_departure');
        populateTable(arrivalsTableBody, arrivalsData, 'fsld_lhr_arrival');
    };
