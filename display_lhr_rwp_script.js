document.addEventListener('DOMContentLoaded', () => {
    ...
    const renderSchedules = () => {
        ...
        const departuresData = allSchedules.lhr_rwp_departure || [];
        const arrivalsData = allSchedules.rwp_lhr_arrival || [];

        populateTable(departuresTableBody, departuresData, 'lhr_rwp_departure');
        populateTable(arrivalsTableBody, arrivalsData, 'rwp_lhr_arrival');
    };
